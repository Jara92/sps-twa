 ...
 */
class Discount extends \EshopBundle\Entity\Discount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'id', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'name', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'description', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'percentage', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'code', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'applied', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'valid_to', '' . "\0" . 'EshopBundle\\Entity\\Discount' . "\0" . 'order'];
        }

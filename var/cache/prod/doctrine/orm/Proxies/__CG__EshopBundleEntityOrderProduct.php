 ...
 */
class OrderProduct extends \EshopBundle\Entity\OrderProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EshopBundle\\Entity\\OrderProduct' . "\0" . 'id', '' . "\0" . 'EshopBundle\\Entity\\OrderProduct' . "\0" . 'product', '' . "\0" . 'EshopBundle\\Entity\\OrderProduct' . "\0" . 'order', '' . "\0" . 'EshopBundle\\Entity\\OrderProduct' . "\0" . 'quantity'];
        }
